<script lang="ts">
    ...
    onMount(async () => {
        ...
        await background.loadFromUrl("./clubs/fond_jeu.png")
        await texteimage.loadFromUrl("./clubs/texte_jeu.png")
...
<div class="grid gap-4 grid-cols-1" spellcheck="false">
    ...
    <Button on:click={() => template.download("Club Jeu")}>Télécharger</Button>
</div>
